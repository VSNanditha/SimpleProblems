# Comparators are used to compare two objects. In this challenge, you'll create a comparator and use it to sort
# an array. The Player class is provided in the editor below. It has two fields:
#
# 1. name: a string.
# 2. score: an integer.
...
#
# For example, given n = 3 Player objects with Player.name, Player.score values of data =
# [[Smith, 20], [Jones, 15], [Jones, 20]], we want to sort the list as
